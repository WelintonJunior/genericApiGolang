...
type Order struct {
	...
	Paid       bool         `gorm:"type:bool;not null" json:"paid"`
	Delivered  bool         `gorm:"type:bool;not null" json:"delivered"`
...
type OrderSnack struct {
	...
	Personalizacao string `gorm:"type:varchar(255)" json:"personalizacao"`
	Snack          Snack  `gorm:"foreignKey:SnackID" json:"snack"`
}
